...
//         Process process;
//         try {
//             process = Runtime.getRuntime().exec("runas /user:Administrator cmd.exe");
//         } catch (IOException e) {
...
//         String LOCKED_ICON_PATH = INSTALL_PATH != null ? INSTALL_PATH + "/" + LOCKED_ICON_FILE_NAME
//                 : LOCKED_ICON_FILE_NAME;
...
public class Main {
    public static void main(String[] args) {
        ...
        String INSTALL_PATH = System.getProperty("InstallationPath");
        String ICON_PATH = INSTALL_PATH != null ? INSTALL_PATH + "/" + ICON_FILE_NAME : ICON_FILE_NAME;
        String LOCKED_ICON_PATH = LOCKED_ICON_FILE_NAME;
        Integer WINDOW_WIDTH = 400;
        Integer WINDOW_HEIGHT = 180;
        String FOLDER_PATH = args.length > 0 ? args[0] : "E:\\newTest";
        String COMMAND = args.length > 1 ? args[1] : "locker";
